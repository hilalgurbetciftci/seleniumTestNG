...
public class ReusableMethods {
    ...
    public static void tumSayfaFografiSS(String fotoName){
        // her dosyanin her ss'nin benzersiz bir isme sahip olması icin
        // 1. method'un cagirildigi yerden resim adı yollanacak
        // 2. sonunsa tarih etiketi ekleyerek 2310062023
        LocalDateTime ldt = LocalDateTime.now();
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyMMddHHmm");
        String tarihEtiketi = ldt.format(formatter);

        // target/screenShot/tumSayfaScreenShot.jpg
        String dinamikDosyayolu = "target/screenShot/"+fotoName+tarihEtiketi+ ".jpg";
